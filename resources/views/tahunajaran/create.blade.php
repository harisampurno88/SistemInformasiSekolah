        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <a href='{{ url('tahunajaran') }}' class="btn btn-secondary">
                << Kembali</a>
                    ...
                    <div class="mb-3 row">
                        <label for="tahun_mulai" class="col-sm-2 col-form-label">Tahun Ajaran</label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control" name='tahun_mulai'
                                value="{{ Session::get('tahun_mulai') }}" id="tahun_mulai">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" name='tahun_selesai'
                                value="{{ Session::get('tahun_selesai') }}" id="tahun_selesai">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="status" class="col-sm-2 col-form-label">Status</label>
                        <div class="col-sm-10">
                            <select class="form-select" name="status" value="{{ Session::get('status') }}"
                                id="status">
