...
<!-- START FORM -->
@section('content')
    <form action='{{ url('matapelajaran/' . $data->id_mata_pelajaran) }}' method='post'>
        @csrf
        @method('PUT')
            ...
            <a href='{{ url('matapelajaran') }}' class="btn btn-secondary">
                << Kembali</a>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name='nama_mata_pelajaran' value="{{ $data->nama_mata_pelajaran }}"
