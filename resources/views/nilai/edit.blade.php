            ...
            <a href='{{ url('nilai') }}' class="btn btn-secondary">
                << Kembali</a>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" name='id_siswa' value="{{ $data->id_siswa }}"
                                id="id_siswa">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" name='id_mata_pelajaran' value="{{ $data->id_mata_pelajaran }}"
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" name='id_tahun_ajaran'
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" name='kehadiran'
                                value="{{ $data->kehadiran }}" id="kehadiran">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="catatan_guru" class="col-sm-2 col-form-label">Catatan Guru</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name='catatan_guru' value="{{ $data->catatan_guru }}"
                                id="catatan_guru">
                        </div>
                    </div>
                    <div class="mb-3 row">
